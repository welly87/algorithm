package com.tambunan.graph.spath;
...
public class ch4_05_dijkstra {
    ...
    */
        ...
        dist.set(source, 0); // INF = 1*10^9 not MAX_INT to avoid overflow
        ...
        pq.offer(new IntegerPair(0, source)); // sort based on increasing distance
